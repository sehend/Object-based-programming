...
void ogrenciekle(ogrenci *ogr2, int son) {
	...
	ogrenci *ogr2 = (ogrenci*)malloc(sizeof(ogrenci));
	printf("\nogrencinin \n");
	ogr2->id = son;
	printf("Idniz (%d)\n", son);
	printf("isim giriniz: ");
...
void ogrencisirala(ogrenci *ogr3) {/*
	//ogrenci *ogr3 = (ogrenci*)malloc(sizeof(ogrenci));
	int i, t, j, k;
	int tut[3];
	float sira[3] = { 0,0,0 };
	float gecici;
...
void eniyiogrenci(ogrenci ogr5[]) {
	ogrenci *ogr5 = (ogrenci*)malloc(sizeof(ogrenci));
	int i, j;
	float gecici;
	printf("\nOgrenci Ortalama Siralamasi\n");
	for (i = 0; i < 0; i++) {
...
void enkotuogrenci(ogrenci ogr6) {
	ogrenci *ogr6 = (ogrenci*)malloc(sizeof(ogrenci));
	int i, j;
	float gecici;
	printf("\nOgrenci Ortalama Siralamasi\n");
	for (i = 0; i < 0; i++) {
		for (j = i + 1; j < 3; j++) {
			if (ogr6.ort < ogr6.ort)
			{
				gecici = ogr6.ort;
				ogr6.ort = ogr6.ort;
				ogr6.ort = gecici;
